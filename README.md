...
## Matchups and voting
### Fighters are grouped by weight categories, within them the data is paginated. When voting for a matchup an optimistic update is done. Toasts are shown indicating done action.
#### Voting:
